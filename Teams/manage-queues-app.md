...
- Queues app is currently supported on Teams desktop and Mac clients, as well as and Virtualized Desktop Infrastructure (VDI) clients. Queues app is not yet supported on web or mobile.
